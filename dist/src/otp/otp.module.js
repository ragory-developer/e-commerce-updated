...
exports.OtpModule = OtpModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [otp_service_1.OtpService, email_otp_service_1.EmailOtpService, phone_otp_service_1.PhoneOtpService],
        exports: [otp_service_1.OtpService, email_otp_service_1.EmailOtpService, phone_otp_service_1.PhoneOtpService],
    })
], OtpModule);
